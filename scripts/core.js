...
function initialize() {
  ...
  document.addEventListener('webkitAnimationStart', function(event){
    if (event.animationName == 'elementInserted') {
      ...
      if(evTarget.hasClass("imagePreview")) {
        evTarget.parent().parent().addClass("hasImagePreview");
      }
      
      if(evTarget.attr("data-cwui-ab-type") == "edit") {
        evTarget.parents("div.timelineMessage").addClass("timelineMessage--mine");
      }
    }
  }, true);
